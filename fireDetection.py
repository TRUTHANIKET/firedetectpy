def fire():
    ...
    def send_mail_function(): # defined function to send mail post fire detection using threading
        ...
        recipientmail = "dogeprograms@gmail.com" # recipients mail
        ...
        try:
            ...
            server.ehlo()
            server.starttls()
            server.login("dogeprograms@gmail.com", 'fhtlkyhpkhgzkvrf') # Senders mail ID and password
            server.sendmail('dogeprograms@gmail.com', recipientmail, "Warning fire accident has been reported") # recipients mail with mail message
